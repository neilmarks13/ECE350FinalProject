...
/*
Originally written by Dr. Bletch, modified for the purposes of ECE350 by Mary Stuart Elder
*/
...
#define OPCODE_VID    0x1f
#define OPCODE_KEY    0x1e
...
instruction_t opcode_arr[] = {
    ...
    instruction_t(OPCODE_VID, OPCODE_ALU_DEFAULT, "vid",  I),
    instruction_t(OPCODE_KEY, OPCODE_ALU_DEFAULT, "key",  R1RS),
};
